...
<%
    // Si viene a null es insert, si no es update
...
<div class="container">
    <div class="form-container">
        ...
        <%
            ...
            // Montar dinámicamente el select y options...
                    ...
                    <%
                        if (fabricantes != null && !fabricantes.isEmpty()) {
                            for (Fabricante f : fabricantes) {
                                ...
                                if (esEdicion)
                                    seleccionado = f.getCodigo().equals(producto.getCodigo_fabricante());
                    %>
                    <option value="<%= f.getCodigo() %>" <%=seleccionado? "selected":""%> > <%= f.getNombre() %> </option>
                    <%
                        }
                    } else {
                    %>
