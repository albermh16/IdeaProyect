...
public class RestaurantController {
    ...
    public ResponseEntity<RestaurantResponseDTO> create(@RequestBody RestaurantRequestDTO restaurantDTO) {

        Optional<RestaurantResponseDTO> result = restaurantService.create(restaurantDTO);
        if (result.isPresent()) {
